...
},{"core-js/modules/web.immediate.js":"49tUX","./model":"Y4A21","./views/mapView":"b2AA2","./views/tflResultsView":"gnEnQ","./views/weatherView":"jcuJR","./views/paginationView":"6z7bi","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
const fetchWeatherData = async function() {
    try {
        const response = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=${(0, _config.API_KEY_WEATHER)}&q=${state.latitude},${state.longitude}`);
        const data = await response.json();
        return data;
    } catch (error) {
        console.error(error);
...
},{"../controller":"aenu9","../model":"Y4A21","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dXNgZ":[function(require,module,exports) {
/**
...
},{}]},["aD7Zm","aenu9"], "aenu9", "parcelRequiree2f9")
